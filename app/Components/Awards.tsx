...
export default function Awards() {
  return (
    <AnimatedSection id="awards" className="py-20">
      <AnimatedContainer className="px-12 mb-12">
      ...
      <section className="w-full py-12 px-12">
        <AnimatedContainer className="grid grid-cols-3 grid-rows-2 gap-6">
          {/* Element 1 — Award Card (spans col 1–2, row 1) */}
          <AnimatedItem className="col-span-2 row-span-1 rounded-2xl bg-white shadow-sm p-6 flex flex-col gap-4">
          ...
          <AnimatedItem className="col-span-1 row-span-2 relative rounded-2xl overflow-hidden bg-gray-200">
            <img
              src="/images/kana.jpg"
              alt="Керамична кана"
          ...
          <AnimatedItem className="col-span-1 row-span-1 rounded-2xl bg-white shadow-sm p-6 flex flex-col justify-center gap-2">
          ...
          <AnimatedItem className="col-span-1 row-span-1 rounded-2xl bg-white shadow-sm p-6 flex flex-col justify-center gap-3">
